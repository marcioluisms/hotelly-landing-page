        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="p-10 rounded-3xl bg-popover border border-border flex flex-col hover:-translate-y-2 transition-transform">
              ...
              <a href="https://adm.hotelly.ia.br/sign-up" className="block text-center w-full py-4 rounded-xl border border-border-strong font-bold hover:bg-popover text-foreground transition-colors" onClick={() => trackConversion('pricing_card', 'start')}>Começar Agora</a>
            </div>
            {/* Pro */}
            <div className="p-10 rounded-3xl bg-popover border-2 border-amber relative shadow-xl shadow-amber/10 flex flex-col scale-105 z-10 transition-transform hover:scale-110">
              ...
              <a href="https://adm.hotelly.ia.br/sign-up" className="block text-center w-full py-4 rounded-xl bg-amber hover:bg-amber-hover text-amber-foreground font-bold hover:shadow-lg hover:shadow-amber/20 transition-all" onClick={() => trackConversion('pricing_card', 'pro')}>Começar Agora</a>
            </div>
            {/* Max */}
            <div className="p-10 rounded-3xl bg-popover border border-border flex flex-col hover:-translate-y-2 transition-transform">
              ...
              <a href="https://adm.hotelly.ia.br/sign-up" className="block text-center w-full py-4 rounded-xl border border-border-strong font-bold text-foreground hover:bg-popover transition-colors" onClick={() => trackConversion('pricing_card', 'max')}>Começar Agora</a>
            </div>
          </div>
        </div>
      </section>
